...
(function(vue, shared) {
  ...
  const __easycom_1 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$6], ["__scopeId", "data-v-d31e1c47"], ["__file", "D:/HbuilderX/HbuilderXProjects/chatGPT/uni_modules/uni-icons/components/uni-icons/uni-icons.vue"]]);
  ...
  const __easycom_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$5], ["__scopeId", "data-v-09fd5285"], ["__file", "D:/HbuilderX/HbuilderXProjects/chatGPT/uni_modules/uni-easyinput/components/uni-easyinput/uni-easyinput.vue"]]);
  const _sfc_main$5 = {
    name: "UniDrawer",
    components: {},
    emits: ["change"],
  ...
  const _sfc_main$4 = {
    ...
    methods: {
        ...
        uni.showModal({
          ...
          success: function(res) {
            if (res.confirm) {
              ...
              formatAppLog("log", "at components/index/drawer.vue:71", "用户点击取消");
            }
          }
        });
      ...
      chooseConversation(cov_id) {
        ...
        formatAppLog("log", "at components/index/drawer.vue:81", "点击对话的时传递的参数是" + cov_id);
      ...
      getConversationId() {
        ...
        uni.request({
          ...
          success: (res) => {
            ...
            const response2 = uni.getStorageSync("chat_history");
            chatData = response2;
            chatData.push({
              "id": conv_id,
              "chatMsg": [{
      ...
      checkStorage() {
        formatAppLog("log", "at components/index/drawer.vue:133", "对话总数为", this.chatNum);
        uni.getStorageSync({
          key: "chat_history",
          success: function(res) {
            formatAppLog("log", "at components/index/drawer.vue:137", res.data[0].id);
          }
        });
      },
  ...
  function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "drawer-container" }, [
      vue.createVNode(
          ...
          default: vue.withCtx(() => [
            vue.createElementVNode("scroll-view", {
                ...
                vue.renderList($data.chatNum, (item, index) => {
                  return vue.openBlock(), vue.createElementBlock("view", {
                    ...
                    vue.createElementVNode("button", {
                      size: "mini",
                      class: vue.normalizeClass([{ selected: $options.isSelected(item) }, "out-button"]),
                      onClick: ($event) => $options.chooseConversation(index + 1)
                    }, "conversation" + vue.toDisplayString(item), 11, ["onClick"]),
                    vue.createElementVNode("button", {
                      size: "mini",
                      class: "in-button",
                      onClick: ($event) => $options.confirmDel(index + 1)
                    }, "x", 8, ["onClick"])
                  ]);
                }),
                128
              ...
              vue.createElementVNode(
                ...
                {
                  size: "mini",
                  class: vue.normalizeClass([{ selected: $data.isSingleOpen }, "single-chat"]),
                  onClick: _cache[1] || (_cache[1] = ($event) => $options.singleQuestion())
                },
                vue.toDisplayString($data.typeChoose),
                3
                /* TEXT, CLASS */
              ),
              vue.createElementVNode("button", {
  ...
  const drawer = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$3], ["__scopeId", "data-v-57831c01"], ["__file", "D:/HbuilderX/HbuilderXProjects/chatGPT/components/index/drawer.vue"]]);
  const _sfc_main$3 = {
    components: {
      drawer
    },
    ...
    methods: {
      ...
      // input(e) {
      // 	__f__('log','at pages/index/index.vue:116',"输入内容", e)
      // },
      scrollToBottom() {
        setTimeout(() => {
      ...
      singleQuestion(isSingle) {
        if (isSingle) {
          ...
          formatAppLog("log", "at pages/index/index.vue:130", `single done${this.questWay}`);
        } else {
          this.questWay = `continuous`;
          formatAppLog("log", "at pages/index/index.vue:133", `test done ${this.questWay}`);
        }
      },
      changeConverId(new_id) {
        formatAppLog("log", "at pages/index/index.vue:137", "shei zai limian");
        formatAppLog("log", "at pages/index/index.vue:139", `new_id is ${new_id}`);
        formatAppLog("log", "at pages/index/index.vue:140", `old_id is ${this.chat_list_id}`);
      ...
      showStorage() {
        uni.getStorage({
          key: "chat_history",
          success: (res) => {
            formatAppLog("log", "at pages/index/index.vue:194", "当前缓存是");
            formatAppLog("log", "at pages/index/index.vue:195", res.data);
          }
        });
      }
    }
      ...
      vue.createElementVNode(
        ...
        [
          vue.createVNode(_component_drawer, {
            onDeleteConver: $options.deleteConver,
            onChangeConverId: $options.changeConverId,
            onSingle: $options.singleQuestion,
            ref: "drawer"
          }, null, 8, ["onDeleteConver", "onChangeConverId", "onSingle"]),
          vue.createElementVNode("scroll-view", {
            "scroll-y": "",
            style: { "height": "100%" },
            ...
            (vue.openBlock(true), vue.createElementBlock(
              vue.Fragment,
              null,
              vue.renderList($data.chatMsg, (item, index) => {
                return vue.openBlock(), vue.createElementBlock("view", { key: index }, [
                  vue.createElementVNode(
                    "view",
                    {
                      class: vue.normalizeClass(["item flex-row", item.position])
                    },
                    [
                      item.position === "left" ? (vue.openBlock(), vue.createElementBlock("image", {
                        key: 0,
                        src: "/static/face.png",
                        class: "face"
                      })) : (vue.openBlock(), vue.createElementBlock("image", {
                        key: 1,
                        src: "/static/natural.png",
                        class: "face"
                      })),
                      vue.createElementVNode(
                        "text",
                        {
                          class: vue.normalizeClass(["content flex-row", item.position]),
                          "user-select": "true"
                        },
            ...
            vue.createElementVNode("button", {
              onClick: _cache[0] || (_cache[0] = (...args) => $options.showStorage && $options.showStorage(...args)),
              style: { "margin-bottom": "500rpx" }
            }, "查看缓存"),
            vue.createElementVNode("view", { id: "bottom" })
          ], 8, ["scroll-into-view"])
        ],
        4
        /* STYLE */
      ),
      vue.createElementVNode("view", { class: "text-btn" }, [
        vue.createElementVNode("view", { style: { "width": "600rpx" } }, [
          vue.createVNode(_component_uni_easyinput, {
            class: "uni-mt-5 input-box",
            trim: "both",
            modelValue: $data.value,
            "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => $data.value = $event),
            placeholder: "请输入内容",
            type: "text",
            onFocus: $options.scrollToBottom,
            clearable: false
          }, null, 8, ["modelValue", "onFocus"])
        ]),
        vue.createElementVNode("view", {
          class: "send-btn",
          "hover-class": "send-btn-click",
          onClick: _cache[2] || (_cache[2] = (...args) => $options.sendClick && $options.sendClick(...args))
        }, [
          ...
          vue.createElementVNode("text", { class: "btn-text" }, "发送")
        ])
      ])
    ]);
  }
  const PagesIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$2], ["__file", "D:/HbuilderX/HbuilderXProjects/chatGPT/pages/index/index.vue"]]);
  const _sfc_main$2 = {
    data() {
      return {
        strogemsg: "what fuck?",
  ...
  function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "main" }, [
      vue.createTextVNode(" still developing "),
      vue.createElementVNode("button", {
        onClick: _cache[0] || (_cache[0] = (...args) => $options.checkStroge && $options.checkStroge(...args))
      }, "验证缓存"),
      vue.createElementVNode(
        "p",
        null,
        vue.toDisplayString($data.thisismsg),
        1
        /* TEXT */
      ),
      vue.createElementVNode(
        "button",
        {
          onClick: _cache[1] || (_cache[1] = (...args) => $options.checkGetStroge && $options.checkGetStroge(...args))
        },
        "验证拿缓存：" + vue.toDisplayString($data.strogemsg),
        1
        /* TEXT */
      )
    ]);
  }
  const PagesMainpageMainpage = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$1], ["__file", "D:/HbuilderX/HbuilderXProjects/chatGPT/pages/mainpage/mainpage.vue"]]);
  const _sfc_main$1 = {};
  function _sfc_render(_ctx, _cache) {
    return vue.openBlock(), vue.createElementBlock("view", null, "still developing");
  }
  const PagesMessageMessage = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__file", "D:/HbuilderX/HbuilderXProjects/chatGPT/pages/message/message.vue"]]);
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "D:/HbuilderX/HbuilderXProjects/chatGPT/App.vue"]]);
  function createApp() {
